            ...
            <div class="row align-items-center mb-3">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title d-flex align-items-center g-2px text-capitalize">
                        ...
                        <span>{{ \App\CPU\translate('اضافة سعر معين لمنتج') }}</span>
                    </h1>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-12 col-sm-6 col-md-6 col-lg-6">
            <div class="form-group">
                <label>{{ \App\CPU\translate('اختار المنتج') }}</label>
        ...
        <div class="col-12 col-sm-6 col-md-6 col-lg-6">
            <div class="form-group">
                ...
                <input type="text" name="price" class="form-control" placeholder="{{ \App\CPU\translate('150') }}" required>
            </div>
        </div>
    </div>
...
<div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
    <div class="card">
            ...
            <div class="w-100">
                <div class="row">
                    <div class="col-12 col-sm-4 col-md-6 col-lg-7 col-xl-8">
                        <h5>{{ \App\CPU\translate('أسعار المنتجات') }}
        ...
        <div class="table-responsive">
            <div class="mb-3">
                <input type="text" id="search-input" class="form-control" placeholder="{{ \App\CPU\translate('بحث باسم المنتج او كود المنتج...') }}" onkeyup="filterTable()">
            </div>
            ...
            @if (count($prices) == 0)
                <div class="text-center p-4">
                    ...
                    <p class="mb-0">{{ \App\CPU\translate('لا توجد بيانات لعرضها') }}</p>
                </div>
            @endif
        </div>
    </div>
