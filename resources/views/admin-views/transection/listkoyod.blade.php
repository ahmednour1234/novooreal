        ...
        <ol class="breadcrumb bg-white px-3 py-2 rounded shadow-sm">
            ...
            <li class="breadcrumb-item">
                <a href="#" class="text-primary">
                    {{ \App\CPU\translate('القيود اليومية') }}
                </a>
            </li>
...
<div class="row py-2 pr-1">
            ...
            <!-- مركز التكلفة -->
            <div class="form-group col-12 col-sm-6 col-md-3">
                <label class="input-label">{{ \App\CPU\translate('مركز التكلفة') }}</label>
                <select name="cost_id" class="form-control js-select2-custom custom-select">
                    <option value="">---{{ \App\CPU\translate('اختار') }}---</option>
    ...
    <div class="col-12 d-flex flex-wrap justify-content-center">
        ...
        <a href="{{ route('admin.account.listkoyod-transection') }}" class="btn btn-danger custom-btn equal-button">
