                        ...
                        <h4 class="card-header">
                            <div class="row justify-content-between align-items-center flex-grow-1">
                                <div class="col-12 col-sm-5">
                                    <span>{{\App\CPU\translate('المخازن النشطة')}}</span>
                                </div>
                                        ...
                                        <div class="flex-between align-items-center mb-1">
                                            <div>
                                                ...
                                                <span class="card-title text-white">
                                                    كود المخزن: {{ \App\Models\Store::where('store_id', $seller->vehicle_code)->first()->store_code }}
                                                </span>
                                                <span class="card-title text-white">
                                                    اسم المخزن: {{ \App\Models\Store::where('store_id', $seller->vehicle_code)->first()->store_name1 }}
                                                </span>
                                               ...
                                               <span class="card-title text-white">
                                                ...
                                                <span class="card-title text-white">
                                                    التحصيلات: {{ number_format($installment_total, 2) }}
                                                </span>
                                                <span class="card-title text-white">
                                                ...
                                                <span class="card-title text-white">
                                                    عدد كميات المنتجات المباعة: {{ $product_count }}
                                                </span>
                                                <span class="card-title text-white">
                                                    عدد كميات المنتجات المرتجعة: {{ $remain_product_count }}
                                                </span>
                                                <span class="card-title text-white">
                                                    عدد كميات المنتجات في المستودع: {{ $total_stock }}
                                                </span>
                                                <span class="card-title text-white">
                                                    عدد كميات المنتجات المتبقية: {{ $remain_stock }}
                                                </span>
                                            </div>
                                        </div>
                                        <!-- End Row -->
